...
class ScheduleListController: UIViewController {
    ...
    private func showCreateEventVC (event: Event? = nil) {
        // need to use the story board to get the instance of the CreateEventController
